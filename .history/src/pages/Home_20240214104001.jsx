...
function App() {
  ...
  function handleLikeClick(book) {
    const likedBooks = JSON.parse(localStorage.getItem("heart")) || [];
    if (!likedBooks.find(item => item.id === book.id)) {
      likedBooks.push(JSON.stringify(book)); // Burada kitap nesnesini JSON formatına çeviriyoruz
      localStorage.setItem("heart", JSON.stringify(likedBooks));
    }
  }
            ...
            <div className="div-section">
              {filteredBooks.map((book) => (
                <Card
                  ...
                  actions={[
                    <HeartOutlined className="heart" key="heart" onClick={() => handleLikeClick(book)} />,
