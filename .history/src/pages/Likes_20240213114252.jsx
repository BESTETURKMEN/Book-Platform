...
function Likes() {
  ...
  const [filteredLikesBooks, setFilteredLikesBooks] = useState(setLikesBook);
              ...
              <Content style={contentStyle}>
                  ...
                  {filteredLikesBooks.map((Likesbook) => (
                    <Card
                      ...
                      cover={<img className="img" alt="" src={Likesbook.photo} />}
                      actions={[
                        <HeartOutlined key="heart" />,
                    ...
                    >
                      <Meta
                        title={<p>{Likesbook.adi}</p>}
                        description={<p>{Likesbook.yazari}</p>}
                      />
                    </Card>
                  ))}
                </div>
